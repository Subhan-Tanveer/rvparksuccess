  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="1600" height="900" viewBox="0 0 1600 900">
    <defs>
      <linearGradient id="g" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <stop offset="100%" stop-color="#080c08"/>
      </linearGradient>
    ...
    <text x="80" y="800" font-family="monospace" font-size="15" letter-spacing="3" fill="rgba(245,166,35,0.85)">${escapeXml(label || 'VIDEO / PHOTO COMING SOON')}</text>
  </svg>`.trim();
